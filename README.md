...
{ "username": "john_doe", "password": "password123", "email": "john@example.com" } User Login httpPOST /api/auth/signin Content-Type: application/json
...
baseUrl: http://localhost:8080 authToken: Bearer {your_jwt_token}
